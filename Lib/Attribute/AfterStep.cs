...
namespace Gauge.CSharp.Lib.Attribute
{
    ...
    public class AfterStep : FilteredHookAttribute
    {
        /// <summary>
        ///     Creates a hook that gets executed after every Step.
        /// </summary>
        public AfterStep()
        {
        }
        ...
        ///     This hook will be executed only after the step that has the given tag.
        ///     <para> Example:</para>
        ///     <para>
        ///         <code>[AfterStep("some tag")]</code>
        ///     </para>
        /// </summary>
        /// <param name="filterTag">Tag to filter the hook execution by.</param>
        public AfterStep(string filterTag) : base(filterTag)
        {
        }
        ...
        ///     This hook will be executed only after the Step that matches the tag filter.
        ///     <para> Example:</para>
        ///     <para>
        ...
        public AfterStep(params string[] filterTags) : base(filterTags)
        {
        }
    }
}